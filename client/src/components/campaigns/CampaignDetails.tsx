...
import { Calendar, Users, Clock, Target, Globe, CheckCircle, AlertCircle, MessageSquare, ArrowUpRight } from 'lucide-react';
...
export default function CampaignDetails({ campaign }: CampaignDetailsProps) {
  ...
  const getStatusIcon = () => {
    switch(campaign.status) {
      ...
      case 'pending': return <AlertCircle className="h-4 w-4 mr-2" />;
